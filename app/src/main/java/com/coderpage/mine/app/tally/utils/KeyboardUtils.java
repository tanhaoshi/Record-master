...
/**
 * Created by MAX on 2018-08-13 18:06.
 * <p>
 */
public class KeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        try {
            InputMethodManager imm =
                    (InputMethodManager) MineApp.getAppContext().getSystemService(Context.INPUT_METHOD_SERVICE);
            if (imm == null) return;
            view.setFocusable(true);
            view.setFocusableInTouchMode(true);
            view.requestFocus();
    ...
    public static void hideSoftInput(final Activity activity) {
        try {
            ...
            Log.i("IndexEditActivity","look at hide soft error message = " + ignored.getMessage().toString());
        }
    }
